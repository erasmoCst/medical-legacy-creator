...
const CTASection = () => {
  return (
    <section className="py-20 md:py-28 bg-secondary-dark relative overflow-hidden">
      {/* Decorative elements */}
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="font-sans text-lg text-offwhite leading-relaxed mb-12 max-w-2xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href="https://wa.me/5541987987873" target="_blank" rel="noopener noreferrer">
              <Button className="border-2 border-offwhite/30 text-offwhite hover:bg-offwhite/10 text-base px-10 py-7 rounded-full transition-all duration-300 bg-transparent">
                Agendar conversa estratégica
              </Button>
            </a>
          </div>

          <p className="font-sans text-sm text-offwhite mt-10">
            Clareza antes de qualquer decisão. Apenas uma conversa para entender suas necessidades.
          </p>
        </div>
      </div>
